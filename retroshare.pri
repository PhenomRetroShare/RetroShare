...
macx-* {
	...
	rs_macos10.11 {
		...
		QMAKE_CXXFLAGS += -Wno-nullability-completeness -Wno-nullability-completeness-on-arrays
		QMAKE_CFLAGS += -Wno-nullability-completeness -Wno-nullability-completeness-on-arrays
	}
